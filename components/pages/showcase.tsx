      ...
      <div className="mx-auto">
        <div className="py-16 lg:text-center">
          ...
          <p className="max-w-3xl mt-4 text-xl leading-7 text-gray-500 dark:text-gray-400 lg:mx-auto">
            Nitehub is one of the fastest growing software collaboration services. It's trusted by thousands of developers in production including teams at Vercel, AWS, Netflix, Microsoft, Disney, and more.
          </p>
        </div>
      </div>
      ...
      <Container>
        <div className="max-w-xl pt-20 pb-24 mx-auto space-y-6 text-center">
          ...
          <div className="mx-auto rounded-md">
            <a
              href="https://github.com/c-eo/dochub/edit/main/docs/components/clients/users.ts"
              target="_blank"
